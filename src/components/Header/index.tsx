                        ...
                        {menuItem.path ? (
                          <Link
                            ...
                            className={`flex py-2 text-lg font-semibold  lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
                              usePathName === menuItem.path
                                ...
                                : "text-blue-500 hover:text-primary dark:text-white/70 dark:hover:text-white"
                            }`}
                          >
                            {menuItem.title}
                          </Link>
                          ...
                          <>
                            <p
                              ...
                              className="flex cursor-pointer items-center justify-between py-2 text-lg font-semibold  text-blue-500 group-hover:text-primary dark:text-white/70 dark:group-hover:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
                            >
                              {menuItem.title}
                              <span className="pl-3">
