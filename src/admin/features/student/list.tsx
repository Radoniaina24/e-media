  ...
  return (
    <div>
      ...
      <div className=" border-stroke shadow-default dark:border-strokedark dark:bg-boxdark rounded-sm border  bg-white px-5 py-5">
        <button
          type="submit"
          className="border-stroke dark:border-form-strokedark mb-3 cursor-pointer  rounded border bg-primary px-4 py-1 text-white outline-none transition hover:bg-opacity-90"
        >
