    ...
    >
      ...
      <div className="">
        <input
          ...
          className={`dark:border-form-strokedark dark:bg-form-input  rounded border-[1.5px] bg-transparent px-5 py-2 font-normal outline-none transition focus:border-primary active:border-primary dark:focus:border-primary ${errors.name && touched.name ? "border-red-500" : "border-stroke"}`}
